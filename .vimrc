...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
		...
		call append(line(".")+1, "	> Author: Lonelam") 
		call append(line(".")+2, "	> Mail: laizenan@gmail.com") 
	...
	if expand("%:e") == 'cpp'
        ...
        call append(line(",")+12 , "#include<set>")
        call append(line(",")+13 , "#include<map>")
        call append(line(",")+14 , "#include<cmath>")
        call append(line(",")+15 , "#include<string>")
        call append(line(",")+16 , "#include<cstdlib>")
        call append(line(",")+17 , "#include<ctime>")
        call append(line(",")+18 , "#include<deque>")
        call append(line(",")+19 , "#include<iomanip>")
        call append(line(",")+20 , "#include<sstream>")
        call append(line(",")+21 , "#include<utility>")
        call append(line(",")+22 , "#include<functional>")
        call append(line(",")+23 , "#include<iostream>")
        call append(line(",")+24 , "using namespace std;")
        call append(line(",")+25 , "typedef pair<int, int> pii;")
